function targetloss = trainClassifier_KNN(weight)
...
% Auto-generated by MATLAB on 2019-04-18 15:44:40
...
load('labeledtotalfeature.mat')
trainingData = labelfeature;
for len = 1:length(labelfeature)
    trainingData(len,1:19) = labelfeature(len,1:19).*weight;
end
...
targetloss = kfoldLoss(partitionedModel, 'LossFun', 'ClassifError');
