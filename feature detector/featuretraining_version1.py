...
'''
#1
sio.savemat('result_curve/Retroflect_surface_reinsertion_2_00_8_35/area_b.mat', {
        'area': total_area
    })
#2
sio.savemat('result_curve/Retroflect_surface_reinsertion_2_00_8_35/perimeter_b.mat', {
        'perimeter': total_perimeter
    })
#3
sio.savemat('result_curve/Retroflect_surface_reinsertion_2_00_8_35/rect_width_b.mat', {
        'rect_width': total_boundrect_width
    })
#4
sio.savemat('result_curve/Retroflect_surface_reinsertion_2_00_8_35/PPD_score_b.mat', {
        'PPD': total_PPD
    })
#5
sio.savemat('result_curve/Retroflect_surface_reinsertion_2_00_8_35/roundness_b.mat', {
        'roundness': total_roundness
    })
#6
sio.savemat('result_curve/Retroflect_surface_reinsertion_2_00_8_35/convexity_b.mat', {
        'convexity': total_convexity
    })
#7
sio.savemat('result_curve/Retroflect_surface_reinsertion_2_00_8_35/curl_b.mat', {
        'curl': total_curl
    })
#8
sio.savemat('result_curve/Retroflect_surface_reinsertion_2_00_8_35/eccentricity_b.mat', {
        'eccentricity_score': total_eccentricity
    })
#9
sio.savemat('result_curve/Retroflect_surface_reinsertion_2_00_8_35/aspect_ratio_b.mat', {
        'aspect_ratio_score': total_aspectratio
    })
#10
sio.savemat('result_curve/Retroflect_surface_reinsertion_2_00_8_35/extent_b.mat', {
        'extent_score': total_extent
    })
#11
sio.savemat('result_curve/Retroflect_surface_reinsertion_2_00_8_35/solidity_b.mat', {
        'solidity_score': total_solidity
    })
#12
sio.savemat('result_curve/Retroflect_surface_reinsertion_2_00_8_35/kcurve_b.mat', {
        'kcurve': total_kcurve
    })
#13
sio.savemat('result_curve/Retroflect_surface_reinsertion_2_00_8_35/areaRGB_b.mat', {
        'areaRGB_score': total_RGB
    })
#14
sio.savemat('result_curve/Retroflect_surface_reinsertion_2_00_8_35/areaHSV_b.mat', {
        'areaHSV_score': total_HSV
    })
#15
sio.savemat('result_curve/Retroflect_surface_reinsertion_2_00_8_35/areaLAB_b.mat', {
